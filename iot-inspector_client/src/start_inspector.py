...
def main():
    ...
    #No cal arrenacar IP forwarding perque ja el tenim aplicat.
   ...
   # ELIMINAR utils.log('[Main] Restoring ARP...')
    
    #No cal arrecnar ARP Spoof
    with host_state.lock:
        host_state.spoof_arp = False

    for t in range(5):
        print('Cleaning up ({})...'.format(5 - t))
        time.sleep(1)
